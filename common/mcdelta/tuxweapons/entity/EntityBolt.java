    ...
    public void onUpdate()
    {
        ...
        if (Assets.isClient() && (potionEffects != null) && (potionEffects.tagCount() > 0))
        {
            ...
            for (int i = 0; i < amount; i++)
            {
                ...
                EntityFX entityfx = Minecraft.getMinecraft().renderGlobal.doSpawnParticle("spell", posX + xOffset, posY + yOffset, posZ + zOffset, 0, 0, 0);
                ...
                if (entityfx != null)
                {
                    ...
                    {
                        PotionEffect effect = PotionEffect.readCustomPotionEffectFromNBT((NBTTagCompound) potionEffects.tagAt(i2));
                        effects.add(effect);
                    }
        ...
        } else
        {
            ...
            Entity var5 = null;
            List<Entity> var6 = worldObj.getEntitiesWithinAABBExcludingEntity(this, boundingBox.addCoord(motionX, motionY, motionZ).expand(1.0D, 1.0D, 1.0D));
            double var7 = 0.0D;
            int var9;
            float var11;
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    DamageSource source = new DamageSourceWeapon("tuxweapons:bolt", var4.entityHit, shootingEntity, null);
                    ...
                    if (var4.entityHit.attackEntityFrom(source, i1 - 1))
                    {
                        if ((potionEffects != null) && (potionEffects.tagCount() > 0))
                        {
                            ...
                            {
                                PotionEffect effect = PotionEffect.readCustomPotionEffectFromNBT((NBTTagCompound) potionEffects.tagAt(i));
                        ...
                        if (var4.entityHit instanceof EntityLiving)
                        {
                            ...
                            if (knockbackStrength > 0)
                            {
                                ...
                                if (var26 > 0.0F)
                                {
                                    var4.entityHit.addVelocity((motionX * knockbackStrength * 0.6000000238418579D) / var26, 0.1D,
                            ...
                            if ((shootingEntity != null) && (var4.entityHit != shootingEntity) && (var4.entityHit instanceof EntityPlayer)
            ...
            {
                worldObj.spawnParticle("crit", posX + ((motionX * var9) / 4.0D), posY + ((motionY * var9) / 4.0D), posZ + ((motionZ * var9) / 4.0D), -motionX, -motionY + 0.2D,
                        -motionZ);
            }
