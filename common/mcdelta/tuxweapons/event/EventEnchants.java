...
public class EventEnchants
{
    ...
    public void livingHurt(LivingHurtEvent event)
    {
        ...
        if (EnchantmentHelper.getEnchantmentLevel(TWContent.hardened.effectId, living.getCurrentItemOrArmor(3)) > 0)
        {
            ...
            map.put(SharedMonsterAttributes.knockbackResistance.getAttributeUnlocalizedName(), new AttributeModifier(living.getPersistentID(), "Enchanted Armor Modifier", 100.0F,
                    0));
