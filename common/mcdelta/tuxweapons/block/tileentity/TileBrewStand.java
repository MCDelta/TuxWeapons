...
public class TileBrewStand extends TileEntityBrewingStand implements ISidedInventory
{
    ...
    {
        ItemStack input = brewingItemStacks[3];
        ...
        if (input != null)
        {
            ...
            for (int i = 0; i < 3; ++i)
            {
                ...
                if (stack != null)
                {
                        ...
                        if (effects != null)
                        {
                            for (int l = 0; l < effects.size(); l++)
                            {
                                if (!(effects.get(l).duration >= 240000))
                                {
                                    ...
                                    if (modification.contains("upgrade") && (effects.get(l).getAmplifier() == 0)
                                            && !Potions.nonUpgradable.contains(Potion.potionTypes[effects.get(l).getPotionID()]))
                                    {
                                        return true;
                                    }

                                    if (modification.contains("infinite") && !Potion.potionTypes[effects.get(l).getPotionID()].isInstant()
                                            && !Potions.nonInifinite.contains(Potion.potionTypes[effects.get(l).getPotionID()]) && (effects.get(l).duration == 24000))
                                    {
                                        return true;
                                    }
                                }
                    ...
                    int vanillaResult = getPotionResult(stack.getItemDamage(), input);

                    if (!Potions.itemToPotion.containsKey(input.getItem()) && !Potions.modifiers.containsKey(input.getItem()) && (Item.potion.getEffects(vanillaResult) == null)
                            && !(input.getItem() instanceof ItemPotion) && (input.getItem() != Item.glassBottle))
                    {
                        return true;
                    }
                }
            ...
            for (int i = 0; i < 3; ++i)
            {
                ...
                if (stack != null)
                {
                    ...
                    if ((brewingItemStacks[3] != null) && (brewingItemStacks[3].getItem() instanceof ItemPotion) && !(effects == null))
                    {
                        ...
                        List<PotionEffect> inputEffects = Item.potion.getEffects(brewingItemStacks[3]);
                    ...
                    if ((stack != null) && (stack.getItem() instanceof ItemPotion))
                    {
                            ...
                            if (effects != null)
                            {
                                if (!effects.isEmpty())
                                {
                                    for (int l = 0; l < effects.size(); l++)
                                    {
                                        ...
                                        if (modification.contains("infinite") && !effects.get(l).getIsPotionDurationMax()
                                                && !Potions.nonInifinite.contains(Potion.potionTypes[effects.get(l).getPotionID()]) && !success
                                                && !((effects.get(l).duration >= 240000) && (effects.get(l).duration == 24000)))
                                        {
                                            infinite = l;
                                            success = true;
                                        }
                        ...
                        if (!Potions.itemToPotion.containsKey(input.getItem()) && !Potions.modifiers.containsKey(input.getItem())
                                && (Item.potion.getEffects(vanillaResult) == null) && !success)
                        {
    ...
    {
        return stack == null ? par1 : (Item.itemsList[stack.itemID].isPotionIngredient() ? PotionHelper.applyIngredient(par1, Item.itemsList[stack.itemID].getPotionEffect())
                : par1);
    }
